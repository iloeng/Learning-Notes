...
:ref:`installation-0.4` and then heading over to the :ref:`quickstart-0.4`.
Besides the quickstart there is also a more detailed :ref:`tutorial-0.4` that
...
the :ref:`api-0.4` documentation.  Common patterns are described in the
:ref:`patterns-0.4` section.
